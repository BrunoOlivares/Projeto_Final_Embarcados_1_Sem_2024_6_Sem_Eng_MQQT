...
#ifdef MBED_CONF_APP_ESP32_DEBUG
ESP32Interface wifi(MBED_CONF_EASY_CONNECT_WIFI_ESP32_EN, MBED_CONF_EASY_CONNECT_WIFI_ESP32_IO0,
                    MBED_CONF_EASY_CONNECT_WIFI_ESP32_TX, MBED_CONF_EASY_CONNECT_WIFI_ESP32_RX,
                    true,
                    MBED_CONF_EASY_CONNECT_WIFI_ESP32_RTS, MBED_CONF_EASY_CONNECT_WIFI_ESP32_CTS,
                    MBED_CONF_EASY_CONNECT_WIFI_ESP32_BAUD_RATE);
#else
ESP32Interface wifi(MBED_CONF_EASY_CONNECT_WIFI_ESP32_EN, MBED_CONF_EASY_CONNECT_WIFI_ESP32_IO0,
                    MBED_CONF_EASY_CONNECT_WIFI_ESP32_TX, MBED_CONF_EASY_CONNECT_WIFI_ESP32_RX,
                    false,
